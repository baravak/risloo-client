@section('auth-form')
    ...
    <div class="mb-4">
        <input autofocus type="text" class="w-full text-sm text-left dir-ltr placeholder-right placeholder-gray-400 border border-gray-300 rounded" id="mobile" name="mobile" placeholder="{{ __('Mobile') }}">

@section('auth-form')
    ...
    <div class="mb-4">
        <input type="text" class="w-full text-sm text-left dir-ltr placeholder-right placeholder-gray-300 border border-gray-300 rounded focus" id="authorized_key" name="authorized_key" value="{{ app('request')->authorized_key }}" placeholder="{{ auth()->check() ? __('Entry Command') : __('Phone') }}">
        {{-- <div class="text-xs text-gray-400 mt-2 cursor-default leading-relaxed">@lang('Login help')</div> --}}
    ...
    <div class="text-xs text-gray-400 cursor-default leading-relaxed mt-4">
        <div>اگر هنوز عضو ریسلو نیستید، روی گزینه <a href="#" class="variable-font-semibold text-gray-500 hover:text-blue-600 transition">عضویت</a> کلیک کنید.</div>
        <div>اگر عضو ریسلو هستید و کلمه عبور خود را فراموش کرده‌اید روی گزینه <a href="#" class="variable-font-semibold text-gray-500 hover:text-blue-600 transition">فراموشی کلمه عبور</a> کلیک کنید.</div>
    </div>

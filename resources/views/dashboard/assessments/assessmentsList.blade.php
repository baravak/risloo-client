                    ...
                    <tr>
                        <td class="px-3 py-2 whitespace-nowrap">
                            <div class="flex items-center">
                                <span class="text-xs text-gray-700 block text-right dir-ltr cursor-default en">{{ $assessment->id }}</span>
                            </div>
                        </td>
                        <td class="px-3 py-2 whitespace-nowrap">
                            <div class="flex items-center">
                        ...
                        <td class="px-3 py-2 whitespace-nowrap text-left dir-ltr">
                            ...
                            <div class="inline-flex">
                                <a href="{{ route('dashboard.samples.create', ['scale' => substr($assessment->id, 1)]) }}" class="block px-4 py-1 text-xs text-brand border border-brand hover:bg-brand hover:text-white rounded-full transition">{{ __('Create sample') }}</a>
                            </div>
                            @endcan
                        </td>
                    </tr>

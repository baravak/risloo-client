...
@section('content')
    ...
    <div class="flex justify-between items-center flex-wrap mb-4">
        ...
        @can('create', [App\TherapyCase::class, $room])
            <a href="{{ route('dashboard.cases.create', ['room' => $room->id]) }}" class="flex items-center justify-center flex-shrink-0 w-10 sm:w-auto h-9 sm:px-4 text-sm text-green-700 border border-green-700 rounded-full hover:bg-green-50 transition mr-4" title="{{ __('Create new case') }}">

    ...
    <div class="border border-gray-200 rounded-sm overflow-hidden">
        ...
        <div class="relative p-4">
                <div class="absolute top-3 left-3 flex">
                    <a href="#" class="flex justify-center items-center flex-shrink-0 border border-gray-500 text-gray-600 hover:bg-gray-50 px-4 h-9 rounded-full text-sm leading-normal transition-all">
                        <span class="font-medium">{{ __('Edit') }}</span>
                    </a>
                    <a href="#" class="flex justify-center items-center flex-shrink-0 border border-gray-500 text-gray-600 hover:bg-gray-50 w-9 sm:w-auto px-4 h-9 rounded-full text-sm leading-normal transition-all mr-2">
            ...
            <div class="flex flex-wrap items-center mt-2">
                ...
                <div class="inline-flex items-center text-gray-500 mb-2 sm:mb-0 ml-6">
                    ...
                    <a href="mailto:{{ $user->email }}" class="block dir-ltr text-right text-sm hover:text-blue-500">{{ $user->email }}</a>
                </div>
                <div class="inline-flex items-center text-gray-500 mb-2 sm:mb-0 ml-6">
                    <i class="fal fa-phone mb-2 ml-2"></i>
                    <a href="tel:+{{ $user->mobile }}" class="block dir-ltr text-right text-sm hover:text-blue-500">+{{ $user->mobile }}</a>
                </div>
            </div>
        </div>
    </div>

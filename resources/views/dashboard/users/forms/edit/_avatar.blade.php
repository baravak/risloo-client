<form class="w-full mt-6" action="{{route('dashboard.users.avatar.store', ['user' => $user->id])}}" method="POST">
    <div>
        <label>
            <input type="file" class="hidden input-avatar" id="avatar-file" name="avatar" accept="image/png, image/jpeg, image/jpg, image/gif">
        ...
        <div data-afile-pannel="avatar-file" class="w-96 h-96 mb-4 content-center mx-auto">

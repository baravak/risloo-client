<div>
    <div class="mt-4">
        ...
        <select multiple data-template="users" id="room_client_id" name="client_id[]" data-title="user.name id" data-avatar="user.avatars.small" id="client_id" data-url-pattern="{{ route('dashboard.room.users.index', ['room' => '%%', 'status' => 'accepted']) }}" data-placeholder="{{ __('Without specified client') }}" class="select2-select">
        </select>
    </div>

...
@else
<div class="form-group form-group-m">
    <select class="select2-select form-control form-control-m has-clear" multiple data-template="users" name="client_id" data-title="name id" id="client_id" data-room-url="{{route('dashboard.users.index', ['type' => 'client'])}}" data-case-url="{{route('dashboard.users.index', ['type' => 'client'])}}" data-placeholder="{{__('Without specified client')}}">
    </select>

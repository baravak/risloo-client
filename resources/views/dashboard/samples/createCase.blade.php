<div>
    ...
    <div class="mt-4">
        ...
        <select data-template="sessions" name="session_id" data-title="manager.name manager.id" id="session_id" data-url="{{ isset($case) ? route('dashboard.sessions.index', ['case' => $case->id]) : '' }}" data-url-pattern="{{ route('dashboard.sessions.index', ['case' => '%%']) }} class="select2-select">
        </select>
    </div>
</div>
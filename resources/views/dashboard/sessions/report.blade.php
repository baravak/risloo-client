<div>
    ...
    <div class="grid grid-cols-1">
        <div href="#" class="flex items-center justify-between border border-gray-200 rounded p-4 hover:bg-gray-50 transition">
            ...
            <a href="#" class="flex items-center justify-center rounded-full text-xs text-green-600 border border-green-600 hover:bg-green-50 h-8 px-4">{{ __('Create report') }}</a>
        </div>
    </div>
</div>
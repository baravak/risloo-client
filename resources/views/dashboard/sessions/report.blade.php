<div>
    ...
    <div class="border border-gray-200 rounded p-4 transition">
        <span class="block text-gray-600 text-sm cursor-default">{{ $session->report }}</span>
    ...
    <div class="flex items-center justify-between border border-gray-200 rounded p-4 transition">
        <span class="text-gray-500 text-xs cursor-default">هنوز گزارشی ثبت نشده است</span>
    ...
    <div class="flex items-center justify-between border border-gray-200 rounded p-4 transition h-16">
        <span class="text-gray-500 text-xs cursor-default">تنها درمان‌گران این پرونده قادر به ثبت و مشاهده گزارش می‌باشند</span>
    </div>
    @endcan
    </div>
</div>

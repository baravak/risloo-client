<div class="card mt-3 col-12 col-md-11" id="calendar" data-url="{{route('dashboard.sessions.calendar')}}" data-from="{{$sessions->getFilter('week')[0]}}" data-to="{{$sessions->getFilter('week')[1]}}" data-xhr="calendar">
    @isset($calendar)

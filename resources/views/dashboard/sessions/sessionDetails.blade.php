<div class="flex justify-between border border-gray-200 rounded p-4 cursor-default">
    ...
    <div class="flex flex-col justify-between">
        ...
        <div>
            <a href="{{$session->route('edit')}}" class="flex items-center justify-center border border-gray-500 rounded-full text-xs text-gray-600 h-8 px-2 hover:bg-gray-50">{{ __('Edit session') }}</a>
        </div>
    </div>
</div>
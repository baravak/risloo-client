<div>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-2">
        @foreach ($case->clients as $client)
            <div class="client-record flex items-center border border-gray-200 rounded px-3 py-2 hover:bg-gray-50 transition cursor-default" data-xhr="client-{{ $client->id }}" data-id="{{ $client->id }}">

<div>
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <div>
            <a href="{{ route('dashboard.sessions.create', ['case'=>$case->id]) }}" class="flex justify-center items-center flex-shrink-0 border border-green-700 text-green-700 px-4 h-7 rounded-full text-xs leading-normal hover:bg-green-50 transition-all">
                <i class="fal fa-plus ml-2"></i>
                <span class="font-medium">{{ __('Add session') }}</span>
            </a>
        </div>
    </div>

<div>
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <div>
            <a href="{{ route('dashboard.samples.create', ['case'=>$case->id]) }}" alt="{{ __('Create sampel') }}" class="flex justify-center items-center flex-shrink-0 border border-green-700 text-green-700 px-4 h-7 rounded-full text-xs leading-normal hover:bg-green-50 transition-all">

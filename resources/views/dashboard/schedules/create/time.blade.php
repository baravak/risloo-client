...
<div class="mt-4">
    ...
    <input type="text" readonly id="specific-date" data-picker-alt="date" dpicker-format="YYYY/MM/DD" value="{{ time() }}" class="border border-gray-500 h-10 rounded px-4 w-full text-sm focus:border-brand focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-opacity-60 date-picker dir-ltr text-left">

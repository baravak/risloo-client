    ...
    <div class="p-4 border border-gray-200 rounded">
        <label>
            ...
            <div data-afile-default="avatar-file" class="flex flex-col items-center">
                <div class="flex justify-center items-center flex-shrink-0 w-24 h-24 md:w-32 md:h-32 bg-gray-300 text-gray-600 text-2xl rounded-full border border-gray-100 overflow-hidden mb-4 relative cursor-pointer">

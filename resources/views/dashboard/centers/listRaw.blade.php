<a href="{{ $center->route('show') }}" class="border border-gray-200 rounded hover:bg-gray-50 transition">
    ...
    <div class="flex justify-center items-center flex-shrink-0 w-24 h-24 ml-4 sm:mx-auto -mt-12 bg-gray-300 text-gray-600 rounded-full border-4 border-white overflow-hidden">
        @avatarOrName($center->detail)
    </div>

    <div class="p-4">
        <div class="text-sm sm:text-base xs:text-start sm:text-center text-gray-700 font-semibold">@displayName($center->detail)</div>

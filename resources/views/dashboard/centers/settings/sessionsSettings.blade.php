                ...
                <div>
                    ...
                    <div>
                        <label class="inline-flex items-start group">
                            <input {{ $platform->selected ? 'checked' : "" }} type="checkbox" name="default" id="default" class="w-3.5 h-3.5 border border-gray-600 rounded-sm focus:ring-1 focus:ring-offset-1">

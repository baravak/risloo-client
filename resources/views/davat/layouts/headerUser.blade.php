<div class="flex" data-xhr="user-header-nav">
    ...
    <a href="{{ route('logout') }}" data-lijax='click' data-method='post' class="flex justify-center items-center w-12 h-12 border border-gray-300 text-gray-400 rounded hover:bg-gray-50 hover:text-red-500 mr-2 group focus direct" title="{{ __('Logout') }}">

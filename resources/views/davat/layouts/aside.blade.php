    ...
    <aside id="aside" class="bg-gray-50 border-l border-gray-200 overflow-y-auto">
        ...
        <ul class="px-2">
            <li class="mb-1">
                ...
                <a href="{{ route('dashboard.home') }}" data-metarget-default class="flex justify-between items-center py-2 px-6 rounded text-gray-900 hover:bg-gray-200 transition">
                    <div class="flex">
                        <i class="fal fa-tachometer-alt-fastest ml-3 mt-0.5"></i>
                        <div>
                            <div class="variable-font-medium">{{ __('Dashboard') }}</div>
                            <div class="text-xs variable-font-light">خلاصه‌ای از سامانه</div>
                        </div>
                    </div>
                </a>
            </li>
            <li class="mb-1">
                <a href="{{ route('dashboard.centers.index') }}" data-metarget="centers-index" class="flex justify-between items-center py-2 px-6 rounded text-gray-900 hover:bg-gray-200 transition">
                    <div class="flex">
                        <i class="fal fa-building ml-3 mt-0.5"></i>
                        <div>
                            <div class="variable-font-medium">{{ __('Therapy centers') }}</div>
                            <div class="text-xs variable-font-light">همه مراکز درمانی</div>
                        </div>
                    </div>
                </a>
                ...
                @if (auth()->myClinic())
                    <ul class="pr-8 mt-2">
                        <li>
                            <a href="{{ route('dashboard.rooms.show', auth()->myClinic()->id) }}" data-metarget="centers-myclinic" data-metarget-pattern="/dashboard/rooms/{{ auth()->myClinic()->id }}.*" class="flex items-center text-sm text-gray-600 py-2 pr-4 border-r border-gray-300 hover:text-gray-800 transition">{{  __('My clinic') }}</a>
                        </li>
                    </ul>
                @endif
                @php
                ...
                @if ($_AsideCenter->count())
                    ...
                    <ul class="pr-8 mt-2">
                        ...
                        <li>
                            <a href="{{ route('dashboard.' . ($_center->type =='personal_clinic' ? 'rooms' : 'centers') . '.show', $_center->id) }}"data-metarget="centers-myclinic-{{ $_center->id }}" data-metarget-pattern="/dashboard/{{ $_center->type =='personal_clinic' ? 'rooms' : 'centers' }}/{{ $_center->id}}.*" class="flex items-center text-sm text-gray-600 py-2 pr-4 border-r border-gray-300 hover:text-gray-800 transition">
                    ...
                    <ul class="pr-8 mt-2">
                        <li>
                            <a href="{{ route('dashboard.centers.index', ['my' => 'yes']) }}" data-metarget="centers-myclinics" class="flex flex-col justify-center text-sm text-gray-600 py-2 pr-4 border-r border-gray-300 hover:text-gray-800 transition">
                                <div class="variable-font-medium">{{  __('My therapy centers') }}</div>
                                <div class="text-xs variable-font-light">مراکز درمانی مرتبط با من</div>
                            </a>
                        </li>
                    </ul>
                    @endif
            ...
            @if (false)
                <li class="mb-1">
                    <a href="{{ route('dashboard.rooms.index') }}" data-metarget="rooms" data-metarget-pattern="^/dashboard/rooms.*" class="flex justify-between items-center py-2 px-6 rounded text-gray-900 hover:bg-gray-200 transition">
                        <div class="flex">
                            <i class="fal fa-door-open ml-3 mt-0.5"></i>
                            <div>
                ...
                <li class="mb-1">
                    <a href="{{ route('dashboard.cases.index') }}" data-metarget="cases" data-metarget-pattern="^/dashboard/cases.*" class="flex justify-between items-center py-2 px-6 rounded text-gray-900 hover:bg-gray-200 transition">
                        <div class="flex">
                            <i class="fal fa-folders ml-3 mt-0.5"></i>
                            <div>
            ...
            @endif
            <li class="mb-1">
                <a href="{{ route('dashboard.sessions.index') }}" data-metarget="session" data-metarget-pattern="^/dashboard/session.*" class="flex justify-between items-center py-2 px-6 rounded text-gray-900 hover:bg-gray-200 transition">
                    <div class="flex">
            ...
            <li class="mb-1">
                <a href="{{ route('dashboard.samples.index') }}" data-metarget="samples" data-metarget-pattern="^/dashboard/samples.*" class="flex justify-between items-center py-2 px-6 rounded text-gray-900 hover:bg-gray-200 transition">
                    <div class="flex">
                        ...
                        <div>
                            ...
                            <div class="text-xs variable-font-light">آزمون‌های گرفته‌شده</div>
                        </div>
                    </div>
                </a>
                @if (auth()->isAdmin() || (auth()->centers() && auth()->centers()->whereIn('acceptation.position', ['manager', 'operator', 'psychologist'])->first()))
                    <ul class="pr-8 mt-2">
                        <li>
                            <a href="{{ route('dashboard.bulk-samples.index') }}" data-metarget="bulk-samples" data-metarget-pattern="^/dashboard/bulk-samples.*" class="flex flex-col justify-center text-sm text-gray-600 py-2 pr-4 border-r border-gray-300 hover:text-gray-800 transition">
                                <div class="variable-font-medium">@lang('Bulk samples')</div>
                                <div class="text-xs variable-font-light">آزمون‌های گروهی گرفته‌شده</div>
                            </a>
                        </li>
                    </ul>
                @endif

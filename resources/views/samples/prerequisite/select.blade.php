...
<select class="border border-gray-500 h-10 rounded pl-4 pr-8 w-full md:w-1/2 lg:w-1/3 text-sm focus:border-brand focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-opacity-60" placeholder="&nbsp;" name="prerequisites[{{$key}}][1]" id="prerequisite_{{$key}}">
